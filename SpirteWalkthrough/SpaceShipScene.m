...
- (void)createSceneContents
{
    ...
    //rock
    SKAction * makeRocks = [SKAction sequence:@[[SKAction performSelector:@selector(addRock) onTarget:self],[SKAction waitForDuration:0.10 withRange:0.15]]];
...
//    SKSpriteNode * hull = [[SKSpriteNode alloc] initWithColor:[SKColor grayColor] size:CGSizeMake(64, 32)];
    SKTexture *texture=[SKTexture textureWithImageNamed:@"rocket"];
    SKSpriteNode *hull = [SKSpriteNode spriteNodeWithTexture:texture];
